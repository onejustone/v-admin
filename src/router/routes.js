...
const asyncRoutes = [
  ...
  {
    name: 'components', path: '/components', component: Layout, redirect: '/components/back_to_up', meta: { icon: 'document', title: '组件', roles: ['admin'] },
    children: [
      ...
      { name: 'expand_tree', path: '/components/expand_tee', component: _import('components/ExpandTree'), meta: { title: '扩展树组件' }},
      { name: 'cascader', path: '/components/cascader', component: _import('components/Cascader'), meta: { title: 'cascader' }}
    ]
  }
]
